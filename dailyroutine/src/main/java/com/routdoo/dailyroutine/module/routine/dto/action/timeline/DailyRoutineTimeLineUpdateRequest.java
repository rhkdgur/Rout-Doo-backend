 ...
 * fileName       : DailyRoutineTimeLineUpdateRequest
 * author         : rhkdg
 * date           : 2024-05-08
 * description    : 일정 타임라인 수정 request
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
 * 2024-05-08        rhkdg       최초 생성
 */
@Schema(description = "일정 타임라인 수정 request")
@Getter
@Setter
public class DailyRoutineTimeLineUpdateRequest {
