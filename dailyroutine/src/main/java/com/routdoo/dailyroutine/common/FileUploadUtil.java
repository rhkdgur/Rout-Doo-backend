...
/**
 * packageName    : com.routdoo.dailyroutine.common
 * fileName       : FileUploadUtil
 * author         : rhkdg
 * date           : 2024-04-22
 * description    : 파일 업로드 util
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
public class FileUploadUtil {
    ...
    private final String[] IMAGE_EXTS = {"bmp","gif","jpg","jpeg","png"};

    private final String[] ALLOW_EXTS = {"bmp","gif","jpg","jpeg","png","xls","xlsx"};
